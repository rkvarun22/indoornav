...
class DeleteLevel extends React.Component{
    render(){
        return(
            <div>
...
<div className="profile btn" onclick="funProfile()">Profile</div>
    ...
    <div className="div2">
      WARNING !<br/><br/>
      You are about to delete the Level : Sample Level 01<br/>

        This will remove all annotation information under this level. <br/>
        This is a non-reversible action.<br/><br/>
        
        If you do not want to delete this level, <br/>
        click CANCEL.
        <br/>
        <div className="cancel btn"> <Link to="/BuildingDash"> Cancel</Link></div>
        If you still want to delete this level, <br/>
          enter your password and click DELETE<br/>
          <div className="pass btn">*****</div>
          <div className="pass btn" ><Link to="/BuildingDash">Delete</Link></div>
